...
<body>
			...
			<div class="navbar-tools">
				...
				<ul class="nav navbar-right">
					<li class="dropdown current-user"><a class="dropdown-toggle"
						href="./${sessionScope.pathCode}/#.do"> <i
							class="clip-youtube "></i> <span class="username">系统使用说明</span> </a>
					</li>
					<!-- start: USER DROPDOWN -->
					<li class="dropdown current-user"><a data-toggle="dropdown"
						data-hover="dropdown" class="dropdown-toggle"
						data-close-others="true" href="javascript:void(0)"><i
							class="clip-user-3 "></i> <span class="username">${sessionScope.user.stuName
								}</span> <i class="clip-chevron-down"></i> </a>
						<ul class="dropdown-menu">
							<li><a href="./${sessionScope.pathCode}/stuInfo.do"> <i
									class="clip-user-2"></i> &nbsp;个人信息 </a>
							</li>
							<li><a href="./${sessionScope.pathCode}/toUpPwd.do"> <i
		...
		<div class="navbar-content">
			...
			<div class="main-navigation navbar-collapse collapse">
				...
				<ul class="main-navigation-menu">
					...
					<li id="stuChoose"><a href="javascript:void(0)"><i
							class=" clip-users-2  "></i> <span class="title">学生选报管理</span><i
							class="icon-arrow"></i> <span class="selected"></span> </a>
						<ul class="sub-menu">
							<li id="stuTeacherInfo"><a
								href="./student/chooTea.do"> <span class="title">导师基本信息</span>
							</a></li>
						</ul>
						<ul class="sub-menu">
							<li id="adminStudentChoose"><a
								href="./student/chooTeaInfo.do"> <span class="title">选报信息</span>
							</a></li>
						</ul>
					</li>
					<li id="stuInfo"><a
						href="./${sessionScope.pathCode}/stuInfo.do"> <i
	...
	<div class="footer clearfix">
		<div class="footer-inner">2017 &copy; 卓越班选报系统 by hb</div>
	...
	<script type="text/javascript">
	var iter = $("#stopGrade");
	var checkGrade = $("#checkGrade");
	if(iter.val() == -1){
		$('#stop').modal();
	}else if(checkGrade.val() == -1){
		$('#stop').modal();
	}
</script>
</body>
