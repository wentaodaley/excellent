...
<body>
				...
				<ul class="nav navbar-right">
					...
					<li class="dropdown current-user"><a data-toggle="dropdown"
						...
						data-close-others="true" href="javascript:void(0)"><i
							class="clip-user-3 "></i> <span class="username">${sessionScope.user.teaName
								}</span> <i class="clip-chevron-down"></i> </a>
						<ul class="dropdown-menu">
							<li><a href="./${sessionScope.pathCode}/teaInfo.do"> <i
									class="clip-user-2"></i> &nbsp;个人信息 </a></li>
							<li><a href="./${sessionScope.pathCode}/#.do"> <i
									class="clip-user-2"></i> &nbsp;修改密码 </a></li>
		...
		<div class="navbar-content">
			...
			<div class="main-navigation navbar-collapse collapse">
				...
				<ul class="main-navigation-menu">
					...
					<li id="teaStuInfo"><a href="javascript:void(0)"><i
							class="clip-picassa 	 "></i> <span class="title">对接学生信息</span><i
							class="icon-arrow"></i> <span class="selected"></span> </a>
						<ul class="sub-menu">
							<li id="stuChooseTeacher"><a
								href="./${sessionScope.pathCode}/chooStu.do"> <span class="title">学生选报</span>
							</a></li>
							<li id="teaStuList"><a
								href="./${sessionScope.pathCode}/teaStuList.do"> <span class="title">对接学生</span>
							</a></li>
						</ul></li>
					<li id="teaInfo"><a href="./${sessionScope.pathCode}/teaInfo.do"><i
	...
	<div class="footer clearfix">
		<div class="footer-inner">2017 &copy;卓越班选报系统by hb</div>
