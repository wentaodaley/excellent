			...
			<div class="panel-body">
				<div class="row">
					<form class="form-horizontal"
						action="./${sessionScope.pathCode}/teacherUp.do" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<select class="form-control" id="teaSex" name="teaSex">
									<option value= false
										<c:if test="${teacher.teaSex == false}">selected="selected"</c:if>>男</option>
									<option value= true
										<c:if test="${teacher.teaSex == true}">selected="selected"</c:if>>女</option>
								</select>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input placeholder=teaEmail class="form-control" id="teaQQ"
